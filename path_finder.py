        ...
        while not self.stop:
            if self.rechercheDemandee:
                ...
                if self.mobile.caseArrivee :
                    ...
                    while ligne == self.mobile.ligne and colonne == self.mobile.colonne or self.mobile.levelCourant.matrice[ligne][colonne] == 1 or\
                          self.mobile.levelCourant.matrice[ligne][colonne] == 0:
                            ...
                            if len(self.listeFermee) > 1:
                                for noeud in self.listeFermee:
                                    if noeud != self.noeudDepart:
                                        ...
                                        for direction in self.directions:
                                            if self.swap:
                                                if self.mobile.levelCourant.matrice[(noeud.ligne+direction[0])%len(self.mobile.levelCourant.matrice)][(noeud.colonne+direction[1])%len(self.mobile.levelCourant.matrice[0])] == 1:
                                                    nbrMurs += 1
                                                    if direction == [-1,0] :
                                                        murEnHaut = True
                                                    elif direction == [0,-1]:
                                                ...
                                                if not (0 <= noeud.ligne+direction[0] < len(self.mobile.levelCourant.matrice)) or \
                                                    ...
                                                    self.mobile.levelCourant.matrice[noeud.ligne+direction[0]][noeud.colonne+direction[1]] == 1 :
                                                    nbrMurs += 1
                                                    if direction == [-1,0] :
                                                        murEnHaut = True
                                                    elif direction == [0,-1]:
